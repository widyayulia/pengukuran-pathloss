...
<nav class="navbar navbar-expand-lg navbar-light bg-dark text-light">  
  ...
  <header class="container bg-transparent text-black">
        <div class="row">
            <div class="col-12 py-4 text-center">
                <h1 class="display-3 fw-bold text-white">Selamat Datang di Menu Pilihan</h1>
  ...
  <div class="card-body">
    ...
    <a href="/pilihling" class="btn btn-success">Pilih</a>
  </div>
</div>
</div>
...
<div class="card" >
  ...
  <div class="card-body">
    ...
    <a href="/lingkungan" class="btn btn-success">Pilih</a>
  </div>
</div>
</div>
</div>
